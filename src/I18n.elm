module I18n exposing (I18n, Language(..), aboutProduct, aboutProductContent, aboutTitle, aboutWhere, aboutWhereContent, aboutWho, aboutWhoContent, arrivedLanguage, buttonRequestAccommodation, buttonServices, currentLanguage, decodeHome, footerContact, footerCopyright, footerLanguage, footerLegal, footerMeeting, footerPrivacyPolicy, footerSupport, footerTermsConditions, formsAge, formsContact, formsCountry, formsEmail, formsError, formsErrorCaptcha, formsErrorContact, formsErrorRequired, formsForename, formsFrom, formsInstitution, formsMessage, formsPhone, formsService, formsSex, formsSexFemale, formsSexMale, formsSexOther, formsSubmit, formsSubmitting, formsSuccess, formsSuccessContact, formsSurname, formsTo, homeHeadline, homeSubline, init, languageFromString, languageToFileName_home, languageToString, languages, loadHome, navbarAbout, navbarHome, navbarHost, navbarPartner, navbarServices, servicesHalfBoard, servicesHostels, servicesReadmore, servicesSelfCatering, servicesTitle, switchLanguage)
