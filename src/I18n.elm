module I18n exposing (I18n, Language(..), aboutProduct, aboutProductContent, aboutTitle, aboutWhere, aboutWhereContent, aboutWho, aboutWhoContent, arrivedLanguage, buttonRequestAccommodation, buttonServices, currentLanguage, decodeHome, footerContact, footerCopyright, footerLanguage, footerLegal, footerMeeting, footerPrivacyPolicy, footerSupport, footerTermsConditions, formsAge, formsContact, formsContentCapybara, formsContentUser, formsCountry, formsEmail, formsError, formsErrorCaptcha, formsErrorContact, formsErrorRequired, formsForename, formsFrom, formsInstitution, formsMessage, formsPhone, formsRatingCapybara, formsRatingHighlyRecommended, formsRatingNotRecommended, formsRatingUser, formsReviewMessage, formsReviewSuccess, formsService, formsSex, formsSexFemale, formsSexMale, formsSexOther, formsSubmit, formsSubmitting, formsSuccess, formsSuccessContact, formsSurname, formsTo, homeHeadline, homeSubline, init, languageFromString, languageToFileName_home, languageToString, languages, languagesDe, languagesEn, languagesEs, languagesFr, languagesIt, languagesPt, loadHome, navbarAbout, navbarHome, navbarHost, navbarPartner, navbarServices, reviewsSeeMore, reviewsSubtitle, reviewsTitle, reviewsTranslated, reviewsUserTypeHost, reviewsUserTypeStudent, servicesHalfBoard, servicesHostels, servicesReadmore, servicesSelfCatering, servicesTitle, switchLanguage)
...
formsRatingHighlyRecommended : I18n -> String
formsRatingHighlyRecommended (I18n _ { home }) =
...
formsRatingNotRecommended : I18n -> String
formsRatingNotRecommended (I18n _ { home }) =
