module I18n exposing (I18n, Language(..), aboutProduct, aboutProductContent, aboutTitle, aboutWhere, aboutWhereContent, aboutWho, aboutWhoContent, arrivedLanguage, buttonRequestAccommodation, buttonServices, currentLanguage, decodeHome, footerContact, footerCopyright, footerLanguage, footerLegal, footerMeeting, footerPrivacyPolicy, footerSupport, footerTermsConditions, formsAge, formsContact, formsContent, formsCountry, formsEmail, formsError, formsErrorCaptcha, formsErrorContact, formsErrorRequired, formsForename, formsFrom, formsInstitution, formsMessage, formsPhone, formsRating, formsService, formsSex, formsSexFemale, formsSexMale, formsSexOther, formsSubmit, formsSubmitting, formsSuccess, formsSuccessContact, formsSurname, formsTo, homeHeadline, homeSubline, init, languageFromString, languageToFileName_home, languageToString, languages, languagesDe, languagesEn, languagesEs, languagesPt, loadHome, navbarAbout, navbarHome, navbarHost, navbarPartner, navbarServices, reviewsSeeMore, reviewsSubtitle, reviewsTitle, reviewsTranslated, reviewsUserTypeHost, reviewsUserTypeStudent, servicesHalfBoard, servicesHostels, servicesReadmore, servicesSelfCatering, servicesTitle, switchLanguage)
...
formsContent : I18n -> String
formsContent (I18n _ { home }) =
...
formsRating : I18n -> String
formsRating (I18n _ { home }) =
