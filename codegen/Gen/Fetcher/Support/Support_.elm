module Gen.Fetcher.Support.Support_ exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Support", "Support_" ]


{-| submit: 
    (Result.Result Http.Error Route.Support.Support_.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Support", "Support_" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
