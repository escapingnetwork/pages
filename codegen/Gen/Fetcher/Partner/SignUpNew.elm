module Gen.Fetcher.Partner.SignUpNew exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Partner", "SignUpNew" ]


{-| submit: 
    (Result.Result Http.Error Route.Partner.SignUpNew.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Partner", "SignUpNew" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
