module Gen.Fetcher.Host.CompleteRegistrationNew exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Host", "CompleteRegistrationNew" ]


{-| submit: 
    (Result.Result Http.Error Route.Host.CompleteRegistrationNew.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "CompleteRegistrationNew" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
