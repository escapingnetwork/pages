module Gen.Fetcher.Host.FullRegistrationNew exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Host", "FullRegistrationNew" ]


{-| submit: 
    (Result.Result Http.Error Route.Host.FullRegistrationNew.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "FullRegistrationNew" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
