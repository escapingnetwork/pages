module Gen.Fetcher.Host.ContinueRegistration exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Host", "ContinueRegistration" ]


{-| submit: 
    (Result.Result Http.Error Route.Host.ContinueRegistration.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "ContinueRegistration" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
                        [ Type.function
                            [ Type.namedWith
                                ...
                                , Type.namedWith
                                    [ "Route", "Host", "ContinueRegistration" ]
                                    "ActionData"
                                    []
                                ]
                            ]
