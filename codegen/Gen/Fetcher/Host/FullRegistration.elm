module Gen.Fetcher.Host.FullRegistration exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Host", "FullRegistration" ]


{-| submit: 
    (Result.Result Http.Error Route.Host.FullRegistration.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "FullRegistration" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
