module Gen.Fetcher.Host.SignUpOld exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Host", "SignUpOld" ]


{-| submit: 
    (Result.Result Http.Error Route.Host.SignUpOld.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "SignUpOld" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
