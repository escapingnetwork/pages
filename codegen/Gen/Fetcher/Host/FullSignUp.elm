module Gen.Fetcher.Host.FullSignUp exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Host", "FullSignUp" ]


{-| submit: 
    (Result.Result Http.Error Route.Host.FullSignUp.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "FullSignUp" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
