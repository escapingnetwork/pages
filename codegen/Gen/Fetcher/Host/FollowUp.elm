module Gen.Fetcher.Host.FollowUp exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Host", "FollowUp" ]


{-| submit: 
    (Result.Result Http.Error Route.Host.FollowUp.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "FollowUp" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
