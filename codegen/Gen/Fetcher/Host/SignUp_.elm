module Gen.Fetcher.Host.SignUp_ exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Host", "SignUp_" ]


{-| submit: 
    (Result.Result Http.Error Route.Host.SignUp_.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "SignUp_" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
