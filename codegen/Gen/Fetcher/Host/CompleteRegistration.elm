module Gen.Fetcher.Host.CompleteRegistration exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Host", "CompleteRegistration" ]


{-| submit: 
    (Result.Result Http.Error Route.Host.CompleteRegistration.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "CompleteRegistration" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
