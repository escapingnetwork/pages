module Gen.Fetcher.Host.SignUpNew exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Host", "SignUpNew" ]


{-| submit: 
    (Result.Result Http.Error Route.Host.SignUpNew.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "SignUpNew" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
