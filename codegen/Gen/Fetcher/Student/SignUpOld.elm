module Gen.Fetcher.Student.SignUpOld exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Student", "SignUpOld" ]


{-| submit: 
    (Result.Result Http.Error Route.Student.SignUpOld.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Student", "SignUpOld" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
