module Gen.Fetcher.Student.SignUpNew exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Student", "SignUpNew" ]


{-| submit: 
    (Result.Result Http.Error Route.Student.SignUpNew.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Student", "SignUpNew" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
