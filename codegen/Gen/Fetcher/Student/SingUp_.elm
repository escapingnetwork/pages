module Gen.Fetcher.Student.SingUp_ exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Student", "SingUp_" ]


{-| submit: 
    (Result.Result Http.Error Route.Student.SingUp_.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Student", "SingUp_" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
