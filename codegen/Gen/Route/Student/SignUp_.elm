module Gen.Route.Student.SignUp_ exposing (annotation_, make_, moduleName_, route, values_)
...
{-| route: RouteBuilder.StatefulRoute Route.Student.SignUp_.RouteParams Route.Student.SignUp_.Data Route.Student.SignUp_.ActionData Route.Student.SignUp_.Model Route.Student.SignUp_.Msg -}
route : Elm.Expression
route =
    Elm.value
        { importFrom = [ "Route", "Student", "SignUp_" ]
        , name = "route"
        , annotation =
            Just
                (Type.namedWith
                    ...
                    [ Type.namedWith
                        ...
                        "RouteParams"
                        []
                    , Type.namedWith [ "Route", "Student", "SignUp_" ] "Data" []
                    , Type.namedWith
                        [ "Route", "Student", "SignUp_" ]
                        "ActionData"
                        []
                    , Type.namedWith
                        ...
                        "Model"
                        []
                    , Type.namedWith [ "Route", "Student", "SignUp_" ] "Msg" []
                    ]
                )
        }
