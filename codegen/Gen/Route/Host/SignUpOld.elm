module Gen.Route.Host.SignUpOld exposing (annotation_, make_, moduleName_, route, values_)
...
moduleName_ =
    [ "Route", "Host", "SignUpOld" ]


{-| route: RouteBuilder.StatelessRoute Route.Host.SignUpOld.RouteParams Route.Host.SignUpOld.Data Route.Host.SignUpOld.ActionData -}
route : Elm.Expression
route =
    Elm.value
        { importFrom = [ "Route", "Host", "SignUpOld" ]
        , name = "route"
        , annotation =
            Just
                (Type.namedWith
                    ...
                    [ Type.namedWith
                        ...
                        "RouteParams"
                        []
                    , Type.namedWith [ "Route", "Host", "SignUpOld" ] "Data" []
                    , Type.namedWith
                        [ "Route", "Host", "SignUpOld" ]
                        "ActionData"
                        []
