module Gen.Route.Support.Support_ exposing (annotation_, make_, moduleName_, route, values_)
...
moduleName_ =
    [ "Route", "Support", "Support_" ]


{-| route: RouteBuilder.StatefulRoute Route.Support.Support_.RouteParams Route.Support.Support_.Data Route.Support.Support_.ActionData Route.Support.Support_.Model Route.Support.Support_.Msg -}
route : Elm.Expression
route =
    Elm.value
        { importFrom = [ "Route", "Support", "Support_" ]
        , name = "route"
        , annotation =
            Just
                (Type.namedWith
                    ...
                    , Type.namedWith
                        ...
                        "Model"
                        []
                    , Type.namedWith [ "Route", "Support", "Support_" ] "Msg" []
                    ]
                )
        }
